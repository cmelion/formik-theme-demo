...
describe('Actions', () => {
    ...
    describe('userAuthenticatedSSO', () => {
        it('should return an action of type LOGIN', () => {
            expect(LoginActions.userAuthenticatedSSO(
                {payload: {}}).type).to.equal(ActionTypes.LOGIN_FULFILLED);
        });
    });
    ...
    describe('userLoggedOut', () => {
        it('should return an action of type LOGOUT', () => {
            expect(LoginActions.userLoggedOut().type).to.equal(ActionTypes.LOGOUT);
        });
    });
